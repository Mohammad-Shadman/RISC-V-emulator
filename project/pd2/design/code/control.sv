    ...
    always_comb begin
        ...
        case(opcode_i)
            ...
            OP_B: begin
                ...
                case(funct3_i)
                    FB_BEQ : cond  = ~(brgt_i | brlt_i);
                    FB_BNE : cond  = (brgt_i | brlt_i);
                    FB_BLT : cond  = brlt_i;
                    FB_BGE : cond  = ~brlt_i;
                    FB_BLTU : begin
                        brun_o = 1;
                ...
                pcsel_o   = PC_IMMI*cond;//we need the decoded rs1 and rs2 to get the correct pcsl
                immsel_o  = 1;
                regwren_o = 0;
                rs1sel_o  = 1;
                rs2sel_o  = 1;
                ...
                wbsel_o   = WB_ALU;//dont care
                alusel_o  = ALU_ADD;
                flush_o   = cond; // default dont take branch
            end
